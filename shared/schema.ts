...
export const dianaConfig = pgTable("diana_config", {
  ...
  ownerName: text("owner_name").notNull().default("Jan"),
  ...
  openDays: text("open_days").notNull().default("Dinsdag t/m zondag"),
  ownerPassphrase: text("owner_passphrase").notNull().default("sono il proprietario"),
  voicePersona: text("voice_persona").notNull().default("elena"),
  elevenLabsVoiceId: text("eleven_labs_voice_id"),
  todayMenu: text("today_menu"),
  tomorrowMenu: text("tomorrow_menu"),
