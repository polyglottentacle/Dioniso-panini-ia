...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 8.90,
    imageUrl: 'https://images.unsplash.com/photo-1513185041617-8ab03f83d6c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
    isPopular: true,
    isVegetarian: false,
    isCustomizable: false
  },
  ...
  },
  {
    id: 21,
    categoryId: 5,
    nameIt: 'Vino Rosso / Bianco (bicchiere)',
    nameEn: 'Red / White Wine (glass)',
    nameEs: 'Vino Tinto / Blanco (copa)',
    descriptionIt: 'Selezione di vini italiani al bicchiere',
    descriptionEn: 'Selection of Italian wines by the glass',
    descriptionEs: 'Selección de vinos italianos por copa',
    price: 4.50,
    imageUrl: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
    isPopular: false,
    isVegetarian: true,
    isCustomizable: false
  }
