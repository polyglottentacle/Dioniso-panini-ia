        ...
        <div className="p-6 md:p-8">
          <div className="md:flex items-start">
            <div className="md:w-1/3 mb-6 md:mb-0 md:pr-8">
              <div className="bg-fisher-blue-dark text-white p-6 rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-semibold">
                    {t('loyalty.level', { level: t(`loyalty.level.${currentLevel}`) })}
                  </h3>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-fisher-gold" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="mb-6">
                  ...
                  <div className="w-full bg-white/20 rounded-full h-2.5">
                    <div 
                      className="bg-fisher-gold h-2.5 rounded-full" 
                ...
                <div>
                  ...
                  <div className="bg-white/10 p-3 rounded flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-fisher-gold mr-3" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clipRule="evenodd" />
                      <path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z" />
                    </svg>
                    <div>
                      <p className="font-medium">{t('loyalty.reward.title')}</p>
                      <p className="text-xs opacity-80">{t('loyalty.reward.points')}</p>
                    </div>
                  </div>
                </div>
              </div>
